//
//  ShopCartWebViewController.m
//  weidong
//
//  Created by zhccc on 2017/11/28.
...
@interface ShopCartWebViewController () <UIWebViewDelegate>
@property (weak, nonatomic) IBOutlet UIWebView *webView;

@end

@implementation ShopCartWebViewController {
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType
{
    ...
    __weak ShopCartWebViewController* wself = self;
