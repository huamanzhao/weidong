//
//  WeidouChargeWebViewController.m
//  weidong
//
//  Created by zhccc on 2018/6/5.
...
@implementation WeidouChargeWebViewController {
    WKWebView *webView;
...
- (void)viewDidLoad {
    ...
    _funcBaseUrl = @"/member/depositCode/recharge?deviceType=mobile";
    _previosUrl = SERVER_MEMBERCETER_URL;
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    //1.2 判断是否为h5首页
    //构造重定向地址、web界面地址
    h5Url  = [NSString stringWithFormat:@"%@%@",SERVER_HTTP_BASE, _funcBaseUrl];
